...
// Fonte: ACBC (Associacao de Ciclismo de BC e Camboriu)
// Mapa: "Vias ciclísticas Implantadas em Balneario Camboriu"
// Levantamento oficial - atualizado 24/03/2015
// Total: 26 vias cicloviarias
// ============================================
...
const CICLOVIAS: CicloviaData[] = [
  { id: '1', nome: 'Ciclovia Av. Martin Luther', tipo: 'ciclovia', cor: '#000000', corBg: 'rgba(0,0,0,0.15)', distancia: '886 m', coordenadas: CICLOVIA_CICLOVIA_AV_MARTIN_LUTHER },
  { id: '2', nome: 'Ciclofaixa Av. Martin Luther', tipo: 'ciclofaixa', cor: '#FF0000', corBg: 'rgba(255,0,0,0.15)', distancia: '762 m', coordenadas: CICLOVIA_CICLOFAIXA_AV_MARTIN_LUTHER },
  { id: '3', nome: 'Ciclovia Av. do Estado 1', tipo: 'ciclovia', cor: '#FF0000', corBg: 'rgba(255,0,0,0.15)', distancia: '1.6 km', coordenadas: CICLOVIA_CICLOVIA_AV_DO_ESTADO_1 },
  { id: '4', nome: 'Ciclovia Av. do Estado 2', tipo: 'ciclovia', cor: '#FF0000', corBg: 'rgba(255,0,0,0.15)', distancia: '858 m', coordenadas: CICLOVIA_CICLOVIA_AV_DO_ESTADO_2 },
  { id: '5', nome: 'Ciclovia 3ª Avenida', tipo: 'ciclovia', cor: '#0000FF', corBg: 'rgba(0,0,255,0.15)', distancia: '1.2 km', coordenadas: CICLOVIA_CICLOVIA_3_AVENIDA },
  { id: '6', nome: 'Ciclovia 4ª Avenida', tipo: 'ciclovia', cor: '#FF0000', corBg: 'rgba(255,0,0,0.15)', distancia: '1.2 km', coordenadas: CICLOVIA_CICLOVIA_4_AVENIDA },
  { id: '7', nome: 'Ciclovia Av. das Flores', tipo: 'ciclovia', cor: '#0000FF', corBg: 'rgba(0,0,255,0.15)', distancia: '860 m', coordenadas: CICLOVIA_CICLOVIA_AV_DAS_FLORES },
  { id: '8', nome: 'Ciclofaixa da Av. Atlântica', tipo: 'ciclofaixa', cor: '#0000FF', corBg: 'rgba(0,0,255,0.15)', distancia: '4.8 km', coordenadas: CICLOVIA_CICLOFAIXA_DA_AV_ATLNTICA },
  { id: '9', nome: 'Ciclofaixa Av. do Estado', tipo: 'ciclofaixa', cor: '#3333FF', corBg: 'rgba(51,51,255,0.15)', distancia: '220 m', coordenadas: CICLOVIA_CICLOFAIXA_AV_DO_ESTADO },
  { id: '10', nome: 'Ciclofaixa da Rua Aqueduto', tipo: 'ciclofaixa', cor: '#FF0000', corBg: 'rgba(255,0,0,0.15)', distancia: '132 m', coordenadas: CICLOVIA_CICLOFAIXA_DA_RUA_AQUEDUTO },
  { id: '11', nome: 'Ciclovia 5ª Avenida', tipo: 'ciclovia', cor: '#FF0000', corBg: 'rgba(255,0,0,0.15)', distancia: '1.4 km', coordenadas: CICLOVIA_CICLOVIA_5_AVENIDA },
  { id: '12', nome: 'Ciclovia Rua Angelina', tipo: 'ciclovia', cor: '#000099', corBg: 'rgba(0,0,153,0.15)', distancia: '498 m', coordenadas: CICLOVIA_CICLOVIA_RUA_ANGELINA },
  { id: '13', nome: 'Ciclovia Marginal Oeste BR 101', tipo: 'ciclovia', cor: '#0000FF', corBg: 'rgba(0,0,255,0.15)', distancia: '1.3 km', coordenadas: CICLOVIA_CICLOVIA_MARGINAL_OESTE_BR_101 },
  { id: '14', nome: 'Ciclovia Rua José Cesário Pereira', tipo: 'ciclovia', cor: '#000099', corBg: 'rgba(0,0,153,0.15)', distancia: '928 m', coordenadas: CICLOVIA_CICLOVIA_RUA_JOS_CESRIO_PEREIRA },
  { id: '15', nome: 'Ciclofaixa Av. Beira Rio', tipo: 'ciclofaixa', cor: '#000000', corBg: 'rgba(0,0,0,0.15)', distancia: '1.3 km', coordenadas: CICLOVIA_CICLOFAIXA_AV_BEIRA_RIO },
  { id: '16', nome: 'Ciclofaixa Rua 3.700', tipo: 'ciclofaixa', cor: '#FF0000', corBg: 'rgba(255,0,0,0.15)', distancia: '184 m', coordenadas: CICLOVIA_CICLOFAIXA_RUA_3700 },
  { id: '17', nome: 'Ciclofaixa Av. Brasil 1', tipo: 'ciclofaixa', cor: '#2196F3', corBg: 'rgba(33,150,243,0.15)', distancia: '772 m', coordenadas: CICLOVIA_CICLOFAIXA_AV_BRASIL_1 },
  { id: '18', nome: 'Ciclofaixa Av. Brasil 2', tipo: 'ciclofaixa', cor: '#009D57', corBg: 'rgba(0,157,87,0.15)', distancia: '1.5 km', coordenadas: CICLOVIA_CICLOFAIXA_AV_BRASIL_2 },
  { id: '19', nome: 'Ciclofaixa Rua 1.001', tipo: 'ciclofaixa', cor: '#2196F3', corBg: 'rgba(33,150,243,0.15)', distancia: '87 m', coordenadas: CICLOVIA_CICLOFAIXA_RUA_1001 },
  { id: '20', nome: 'Ciclofaixa Rua 1.901', tipo: 'ciclofaixa', cor: '#FF0000', corBg: 'rgba(255,0,0,0.15)', distancia: '97 m', coordenadas: CICLOVIA_CICLOFAIXA_RUA_1901 },
  { id: '21', nome: 'Ciclofaixa Rua 2.550', tipo: 'ciclofaixa', cor: '#000000', corBg: 'rgba(0,0,0,0.15)', distancia: '834 m', coordenadas: CICLOVIA_CICLOFAIXA_RUA_2550 },
  { id: '22', nome: 'Ciclofaixa Rua 2.000', tipo: 'ciclofaixa', cor: '#000000', corBg: 'rgba(0,0,0,0.15)', distancia: '895 m', coordenadas: CICLOVIA_CICLOFAIXA_RUA_2000 },
  { id: '23', nome: 'Ciclofaixa Rua 3.000', tipo: 'ciclofaixa', cor: '#FF0000', corBg: 'rgba(255,0,0,0.15)', distancia: '469 m', coordenadas: CICLOVIA_CICLOFAIXA_RUA_3000 },
  { id: '24', nome: 'Ciclofaixa Estrada da Rainha', tipo: 'ciclofaixa', cor: '#FF0000', corBg: 'rgba(255,0,0,0.15)', distancia: '1.1 km', coordenadas: CICLOVIA_CICLOFAIXA_ESTRADA_DA_RAINHA },
  { id: '25', nome: 'Ciclovia Túnel 2 BR 101', tipo: 'ciclovia', cor: '#FF0000', corBg: 'rgba(255,0,0,0.15)', distancia: '72 m', coordenadas: CICLOVIA_CICLOVIA_TNEL_2_BR_101 },
  { id: '26', nome: 'Ciclovia Travessia Av. Estado', tipo: 'ciclovia', cor: '#009D57', corBg: 'rgba(0,157,87,0.15)', distancia: '32 m', coordenadas: CICLOVIA_CICLOVIA_TRAVESSIA_AV_ESTADO },
];
