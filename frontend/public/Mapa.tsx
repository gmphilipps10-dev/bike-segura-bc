          ...
          <div className="flex items-center gap-3 mb-2.5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-slate-400 truncate">
                {activeTab === 'Rastreamento' ? `${bikes.length} equipamento(s)` : `${ocorrencias.filter(o => o.tipo === 'manual').length} reportada(s) / ${ocorrencias.filter(o => o.tipo === 'monitorado').length} monitorada(s)`}
              </p>
            </div>
